...
wget -O acme.sh https://raw.githubusercontent.com/vipfan/btpanel5.9.1/master/acme.sh -T 5
...
if [ ! -f $acme_path/acme.sh ];then
    if [ -f /.acme.sh/acme.sh ];then
		...
		if [ ! -f $public_file ];then
			wget -O $public_file https://raw.githubusercontent.com/vipfan/btpanel5.9.1/master/public.sh -T 5;
		fi
		. $public_file
...
if [ ! -f $dns_bt ];then
	wget -O $dns_bt https://raw.githubusercontent.com/vipfan/btpanel5.9.1/master/dns_bt.sh -T 5
fi
