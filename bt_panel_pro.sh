...
install_python_for_CentOS6() {
    py_for_centos="https://raw.githubusercontent.com/vipfan/btpanel5.9.1/master/python_for_centos6.sh"
...
install_btPanel_for_CentOS() {
    yum install -y wget && wget -O install.sh https://raw.githubusercontent.com/vipfan/btpanel5.9.1/master/install.sh && sh install.sh
    wget -O update.sh https://raw.githubusercontent.com/vipfan/btpanel5.9.1/master/update_pro.sh && bash update.sh pro
}

install_btPanel_for_APT() {
    wget -O install.sh https://raw.githubusercontent.com/vipfan/btpanel5.9.1/master/install-ubuntu.sh && sudo bash install.sh
    wget -O update.sh https://raw.githubusercontent.com/vipfan/btpanel5.9.1/master/update_pro.sh && bash update.sh pro
}
